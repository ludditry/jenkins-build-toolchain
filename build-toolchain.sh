...
git_refresh https://github.com/zerovm/zerovm master
...
#git_refresh https://github.com/zerovm/gcc master ${TOOLCHAIN_PATH}/toolchain/SRC/gcc

for d in gcc linux-headers-for-nacl glibc newlib binutils; do
